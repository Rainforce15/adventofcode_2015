"use strict";var R=process.argv,L=e=>e.length,T=R[L(R)-1],U=undefined,E="",B=isNaN,P=(s,c)=>s.split(c),N=s=>P(s,"\n").slice(0,-1),K=Object.keys,Q=require,I=T.substr(0,L(T)-1),F=(a,f)=>a.forEach(f),S={
    1:{
        a:d=>{var f=0;F(P(d,E),e=>f+={"(":1,")":-1}[e]);return f;},
        b:d=>{for(var i=0,f=0;i<L(d);i++){f+={"(":1,")":-1}[d[i]];if(f<0)return i+1}}
    },
    2:{
        a:d=>{var r=0;F(N(d).map(e=>P(e,"x")),e=>{var x=e[0]*e[1],y=e[1]*e[2],z=e[2]*e[0];r+=2*(x+y+z)+(x<y?x<z?x:z:y<z?y:z);});return r;},
        b:d=>{var r=0;F(N(d).map(e=>P(e,"x")),e=>{var l=+e[0],w=+e[1],h=+e[2];r+=2*(l>w?l>h?w+h:w+l:w>h?l+h:w+l)+l*w*h;});return r;}
    },
    3:{
    ...
    6:{
        ...
        c:(d,t)=>{
            var m=[],c=0,o=",",i,j,a,v;F(N(d).map(e=>P(e,/ (?!o)/g).map(e=>e.indexOf(o)>-1?P(e,o):e)),e=>{for(i=+e[1][1];i<+e[3][1]+1;i++){for(j=+e[1][0];j<+e[3][0]+1;j++){
    ...
    7:{
        ...
        c:(d,t)=>{
            ...
            F(N(d).map(e=>P(e,/ -> /g)),e=>{
                f=P(e[0],' ');if(!s[e[1]])s[e[1]]={v:U,o:[]};if(L(f)==1){
    ...
    9:{
        ...
        c:(d,t)=>{
            ...
            F(N(d),e=>{l=P(e,/ to | = /g);Y(0,1);Y(1,0);});k=K(n);for(i=0;i<L(k);i++){p=[k[i]];X(p[0]);}return z;
        }
    },
    10:{
    ...
    13:{
        ...
        c:(d,t)=>{var n={},p,l,z=0,i,k,c,o={}, Y=(a,b)=>c+=n[a][b]+n[b][a], X=b=>{if(L(p)<L(k)){var o=K(n[b]);
            ...
            F(N(d),e=>{l=P(e,/ .*?d | h.*?o |\./g);l[1]=P(l[1]," ");if(!n[l[0]])n[l[0]]={};n[l[0]][l[2]]=+l[1][1]*(l[1][0]=="gain"?1:-1);});
    ...
    14:{
        ...
        c:(d,t)=>{
            var c,g,h,i,n={},p={};for(i=0;i<2503;i++) {F(N(d),e=>{
                e=P(e,/ .*?y | .*?r | /g);if(i%(+e[2]+(+e[3]))<+e[2])n[e[0]]=n[e[0]]?(n[e[0]]+(+e[1])):(+e[1]);});
    ...
    15:{
        ...
        c:(d,t)=>{
            var f={},g,s=0,i,b=1,c,n,h,k,v,w,x,y,z,l=100;F(N(d),e=>{g=P(e,/: |, | /g);f[g[0]]=[+g[2],+g[4],+g[6],+g[8],+g[10],0];});k=K(f);
    ...
    16:{
        ...
        c:(d,t)=>{
            ...
            F(N(d),e=>{if(!f){e=P(e,/Sue |: |, /g);f=e[1];for (var i=2;i<L(e);i+=2) {if(t){if((e[i]=="cats"||e[i]=="trees")){if(s[e[i]]>=e[i+1])f=0;}
    ...
    17:{
        ...
        c:(d,t)=>{
            d=N(d);var m=[],c=0,s,b=1,i,j,k,n=i=>{if(!~m.indexOf(0))b=0;else{m[i]++;if(m[i]>1){m[i]=0;n(i+1);}}};F(d,e=>m.push(0));
    ...
    18:{
        ...
        c:(d,t)=>{
            var l=[],n,z=[-1,0,1],c=0,r=(x,y,a)=>t&&(y==0||y==L(l)-1)&&(x==0||x==L(a)-1),u,s=c=>{
                ...
                l=u;if(c>1)s(c-1);
            };F(N(d),e=>l.push(P(e,E)));F(l,(a,y)=>{F(a,(e,x)=>{if(r(x,y,a))l[y][x]="#";});});
    ...
    23:{
        ...
        c:(d,t)=>{
            d=N(d).map(e=>e.split(/,? /g));var a={a:t,b:0},x,y,z,q,i=0;
            while(i>=0&&i<L(d)){
                [x,y,z]=d[i];q={
                    hlf:e=>a[y]=a[y]/2|0,
                    tpl:e=>a[y]*=3,
    ...
    24:{
        a:d=>S[24].c(d),b:d=>S[24].c(d,1),
        c:(d,t)=>{
            d=N(d).map(e=>+e);var f=d.map((e,i)=>L(d)-i-1),w=d.reduce((l,e)=>l+e,0)/(t?4:3),v=e=>e.reduce((l,e)=>l+d[e],0),x=[],q=[],i,p,r,m,
                g=(e)=>{m=0;for(i=L(e)-1;i>=0;i--)if(e[i]>=m)m=e[i];else return;return 1;},
                u=(e)=>{m=[];for(i=0;i<L(e);i++)if(m.indexOf(e[i])>-1)return;else m.push(e[i]);return 1;},
                c=(e)=>{do{e[0]--;for(i=0;i<L(e);i++)if(e[i]<0){e[i]=L(d)-1;if(i<L(e)-1)e[i+1]--;}}while(!u(e)||v(e)<w);return e;};
            for(i=0;v(x)<w;i++){x.unshift(f[i]);}
            while(q==0){while(!g(x)){if(v(x)==w){r=x.map(e=>d[e]).reduce((l,e)=>l*e,1);if(q==0||q>r)q=r;}p=x[0];c(x);}x.sort();x.unshift(L(d)-L(x)-1);}
            return q;
        }
    },
    25:{
